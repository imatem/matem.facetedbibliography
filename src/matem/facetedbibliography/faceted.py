...
class FacetedView(BrowserView):
	...
	self.request = request
        ...
        list_empty = Set([])
        self.interface_principal = interface.interface(list_empty, self.researchers_file , bib_file,False)
        ...
        self.interface_citation = interface.interface(self.list_c, self.researchers_file, bib_file,True)
        self.interface_reference = interface.interface(self.list_r, self.researchers_file, bib_file,True)
